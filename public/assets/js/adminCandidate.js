  ...
  $(function() {
    ...
    $(function() {
      $('#dataTableExample').DataTable({
        ...
        'ajax': {
          type:'POST',
          url: aurl + "/admin/application/listing", 
      },
      'columns': [
          { data: 'id' },
          { data: 'post' },
...
$(document).ready(function(){
    ...
    $('#interview_form').validate({ // initialize the plugin
        rules: {
            name: {
                required: true
            },
    ...
    $('body').on("click", ".add_interview", function(){
        ...
        $('.id').val(id);
        $.ajax({
            url: aurl + "/admin/application/name/show",
            type: "POST",
            data: {id:id},
            dataType: "JSON",
                    ...
                    success: function(data) {
                        if(data.status){
                            swalWithBootstrapButtons.fire({
                                ...
                                if(result.value){
                                    window.location.href = aurl + "/admin/application";
                                }
                            })
                        }else{
                            swalWithBootstrapButtons.fire(
