...
Route::get('/',[CandidateController::class,'opening'])->name('candidate.opening');
Route::get('apply/{id}',[CandidateController::class,'candidateApply'])->name('candidate.apply');
Route::post('apply-submit',[CandidateController::class,'ApplySubmit'])->name('apply.submit');
