        ...
        <div class="row">
          ...
          <div class="col-md-8 ps-md-0">
            <div class="auth-form-wrapper px-4 py-5">
              ...
              {{-- registration form --}}
              <form class="forms-sample" name="registration" method="POST" action="{{ route('candidate.store') }}">
                @csrf
                <div class="mb-3">
                  <label for="fullname" class="form-label">Full Name</label>
                  <input type="text" class="form-control" id="fullname" autocomplete="fullname" name="fullname" placeholder="Full Name">
                </div>
                <div class="mb-3">
