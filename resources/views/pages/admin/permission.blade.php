...
<div class="modal fade  bd-example-modal-lg" id="permission_modal" tabindex="-1" aria-labelledby="title_permission_modal" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="title_permission_modal">Add Job Opening</h5>
          ...
          <div class="row">
            ...
            <div class="col-2 ">
              @if(in_array("14", permission()))
                <a  class="btn btn-primary add_permission"  style="float: right" id="add_permission">Add permission</a>
              @endif
              </div>
          </div>
